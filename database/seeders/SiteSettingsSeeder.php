...
class SiteSettingsSeeder extends Seeder
{
    public function run(): void
    {
        $defaults = [
            ...
            ['key' => 'header.visit_cta_label', 'value' => 'Plan your visit', 'type' => 'text', 'group' => 'header'],
            ['key' => 'header.visit_cta_url', 'value' => '/contact', 'type' => 'text', 'group' => 'header'],
            ['key' => 'home.welcome.eyebrow', 'value' => 'A word of welcome', 'type' => 'text', 'group' => 'home'],
            ['key' => 'home.welcome.heading', 'value' => 'However you got here, we are glad.', 'type' => 'text', 'group' => 'home'],
            ['key' => 'home.welcome.lede', 'value' => 'Whether you are exploring faith for the first time or have walked with Christ for decades, you will find a place here.', 'type' => 'text', 'group' => 'home'],
            ['key' => 'home.welcome.quote', 'value' => 'Come to me, all you who are weary…', 'type' => 'text', 'group' => 'home'],
            ['key' => 'home.welcome_image', 'value' => 'uploads/yRT3rmrD_amjid-and-nazia.jpeg', 'type' => 'text', 'group' => 'home'],
            ['key' => 'about.story_image', 'value' => 'uploads/pages/yp0EeGYMexBpkizJSy5KhUkpwljsA5xXk51ZQABI.jpg', 'type' => 'text', 'group' => 'about'],
            // Phase 3 additions

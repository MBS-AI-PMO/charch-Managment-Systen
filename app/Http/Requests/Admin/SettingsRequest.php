...
class SettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'donate.button_label' => 'nullable|string|max:100',
            'header.visit_cta_label' => 'nullable|string|max:100',
            'header.visit_cta_url' => 'nullable|string|max:500',
            'home.welcome.eyebrow' => 'nullable|string|max:200',
            'home.welcome.heading' => 'nullable|string|max:300',
            'home.welcome.lede' => 'nullable|string|max:500',
            'home.welcome.quote' => 'nullable|string|max:300',
            'home.welcome_image' => 'nullable|string|max:500',
            'about.story_image' => 'nullable|string|max:500',

...
<head>
    ...
    <title>Set new password | Church CMS Admin</title>
    ...
    <div class="min-h-screen lg:grid lg:grid-cols-2">
        <aside class="hidden lg:flex flex-col justify-between bg-brand-primary text-white p-12 relative overflow-hidden">
            ...
            <div class="relative max-w-md">
                <p class="font-serif text-2xl leading-snug">Choose a strong password to protect your account.</p>
            </div>
        ...
        <main class="flex items-center justify-center p-6 lg:p-12">
            <div class="w-full max-w-md">
                ...
                <p class="text-sm text-ink-muted mb-8">Minimum 8 characters.</p>

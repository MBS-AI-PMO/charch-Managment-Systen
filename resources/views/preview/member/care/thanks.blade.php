    ...
    <div class="max-w-xl mx-auto px-4 py-20">
        <div class="card p-10 text-center">
            ...
            <div class="mt-8 flex flex-wrap gap-2 justify-center">
                <a href="{{ route('preview.member.dashboard') }}" class="btn-primary text-sm">Back to dashboard</a>
                <a href="{{ route('preview.member.care') }}" class="btn-ghost text-sm">View my requests</a>
            </div>
        </div>
    </div>
</x-member.layout>
